...
entity dac_bd_1_AXI_Control_Registers_0_0_AXI_Control_Registers_v1_0_S00_AXI is
  port (
...
architecture STRUCTURE of dac_bd_1_AXI_Control_Registers_0_0_AXI_Control_Registers_v1_0_S00_AXI is
  ...
  signal clr_pulse_reg_i_1_n_0 : STD_LOGIC;
  signal ldac_pulse_reg_i_1_n_0 : STD_LOGIC;
  signal ldac_pulse_reg_i_2_n_0 : STD_LOGIC;
  signal macro_start_reg_i_1_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
  signal p_0_in_0 : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal p_1_in : STD_LOGIC_VECTOR ( 31 downto 2 );
  signal reg_data_out : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal rst_pulse_reg_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of clr_pulse_reg_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of ldac_pulse_reg_i_2 : label is "soft_lutpair2";
...
clr_pulse_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      ...
      I1 => p_0_in_0(1),
      I2 => p_0_in_0(2),
      O => clr_pulse_reg_i_1_n_0
    );
clr_pulse_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => '1',
      D => clr_pulse_reg_i_1_n_0,
      Q => O_CLR_CTRL,
      R => ldac_pulse_reg_i_1_n_0
    );
ldac_pulse_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
      ...
      I3 => \^s_axi_wready\,
      I4 => s00_axi_awvalid,
      O => ldac_pulse_reg_i_1_n_0
    );
ldac_pulse_reg_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      I1 => p_0_in_0(0),
      I2 => p_0_in_0(2),
      O => ldac_pulse_reg_i_2_n_0
    );
ldac_pulse_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => '1',
      D => ldac_pulse_reg_i_2_n_0,
      Q => O_LDAC_CTRL,
      R => ldac_pulse_reg_i_1_n_0
    );
macro_start_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
      ...
      I1 => p_0_in_0(0),
      I2 => p_0_in_0(2),
      O => macro_start_reg_i_1_n_0
    );
macro_start_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => '1',
      D => macro_start_reg_i_1_n_0,
      Q => O_MACRO_START,
      R => ldac_pulse_reg_i_1_n_0
    );
rst_pulse_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      ...
      I1 => p_0_in_0(0),
      I2 => p_0_in_0(2),
      O => rst_pulse_reg_i_1_n_0
    );
rst_pulse_reg_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dac_bd_1_AXI_Control_Registers_0_0_AXI_Control_Registers_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    O_LDAC_CTRL : out STD_LOGIC;
...
entity dac_bd_1_AXI_Control_Registers_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of dac_bd_1_AXI_Control_Registers_0_0 : entity is "dac_bd_1_AXI_Control_Registers_0_0,AXI_Control_Registers_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of dac_bd_1_AXI_Control_Registers_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of dac_bd_1_AXI_Control_Registers_0_0 : entity is "AXI_Control_Registers_v1_0,Vivado 2023.1";
end dac_bd_1_AXI_Control_Registers_0_0;

architecture STRUCTURE of dac_bd_1_AXI_Control_Registers_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of O_CLR_CTRL : signal is "xilinx.com:signal:data:1.0 O_CLR_CTRL DATA";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of O_CLR_CTRL : signal is "XIL_INTERFACENAME O_CLR_CTRL, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of O_LDAC_CTRL : signal is "xilinx.com:signal:data:1.0 O_LDAC_CTRL DATA";
  attribute X_INTERFACE_PARAMETER of O_LDAC_CTRL : signal is "XIL_INTERFACENAME O_LDAC_CTRL, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of O_LDAC_FORCE_CTRL : signal is "xilinx.com:signal:data:1.0 O_LDAC_FORCE_CTRL DATA";
  attribute X_INTERFACE_PARAMETER of O_LDAC_FORCE_CTRL : signal is "XIL_INTERFACENAME O_LDAC_FORCE_CTRL, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of O_MACRO_START : signal is "xilinx.com:signal:data:1.0 O_MACRO_START DATA";
  attribute X_INTERFACE_PARAMETER of O_MACRO_START : signal is "XIL_INTERFACENAME O_MACRO_START, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of O_RST_CTRL : signal is "xilinx.com:signal:data:1.0 O_RST_CTRL DATA";
  attribute X_INTERFACE_PARAMETER of O_RST_CTRL : signal is "XIL_INTERFACENAME O_RST_CTRL, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of O_SOURCE_SELECT : signal is "xilinx.com:signal:data:1.0 O_SOURCE_SELECT DATA";
  attribute X_INTERFACE_PARAMETER of O_SOURCE_SELECT : signal is "XIL_INTERFACENAME O_SOURCE_SELECT, LAYERED_METADATA undef";
  ...
  attribute X_INTERFACE_INFO of O_MACRO_CONFIG : signal is "xilinx.com:signal:data:1.0 O_MACRO_CONFIG DATA";
  attribute X_INTERFACE_PARAMETER of O_MACRO_CONFIG : signal is "XIL_INTERFACENAME O_MACRO_CONFIG, LAYERED_METADATA undef";
