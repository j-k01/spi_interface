...
//--------------------------------------------------------------------------------
//Command: generate_target bd_d378.bd
//Design : bd_d378
...
module bd_d378
   (clk,
    ...
    probe8,
    probe9);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN dac_bd_1_processing_system7_0_1_FCLK_CLK0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [31:0]probe0;
  input [0:0]probe1;
  input [0:0]probe10;
  input [0:0]probe11;
