...
#
# Script generated by Vivado on Tue Jun 10 11:56:38 -0700 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dac_bd_1.sh
...
#
# Usage        : dac_bd_1.sh
#                dac_bd_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dac_bd_1.sh [-reset_run]
#                dac_bd_1.sh [-reset_log]
#                dac_bd_1.sh [-help]
#
...
#                script (type 'dac_bd_1.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dac_bd_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/aed8/hdl" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/ec67/hdl" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/aed8/hdl" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/1b7e/hdl/verilog" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/122e/hdl/verilog" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/affe/hdl/verilog" +incdir+"../../../../DACmachine.gen/sources_1/bd/dac_bd_1/ipshared/20d0/hdl/verilog" +incdir+"E:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dac_bd_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dac_bd_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dac_bd_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dac_bd_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dac_bd_1.sh [-help]\n\
Usage: dac_bd_1.sh [-step]\n\
Usage: dac_bd_1.sh [-lib_map_path]\n\
Usage: dac_bd_1.sh [-reset_run]\n\
Usage: dac_bd_1.sh [-reset_log]\n\
Usage: dac_bd_1.sh [-keep_index]\n\
Usage: dac_bd_1.sh [-noclean_files]\n\n\
